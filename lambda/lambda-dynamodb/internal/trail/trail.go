...
func Print(level int, msg string, i ...any) {
	entry := new(Trail)
	entry.Level = trailLevel[level]
	entry.Message = fmt.Sprintf(msg, i...)
	entry.SetTimeStamp()
